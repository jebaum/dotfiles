...
(define-key evil-motion-state-map "\C-f" 'evil-search-forward)
...
(define-key evil-inner-text-objects-map ")" 'evil-inner-paren)
(define-key evil-inner-text-objects-map "p" 'evil-inner-paren)
...
(define-key evil-visual-state-map "\C-c" 'evil-exit-visual-state)
