...
" forked from https://github.com/TKNGUE/vim-quickrun-neovim-job to add third
" arg to callback functions
...
function! s:_job_exit_cb(channel, exit_status, event) abort
  let session = quickrun#session(s:runner._key)
