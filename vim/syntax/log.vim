...
syn match log_error 	'\c.*\<\(FATAL\|ERROR\|ERRORS\|FAIL\|FAILED\|FAILURE\|EXCEPTION\|FAULT\|INVALID\).*'
syn match log_warning 	'\c.*\<\(WARNING\|DELETE\|DELETING\|DELETED\|RETRY\|RETRYING\|PERMISSION\|UNABLE\|.\+EXCEPTION\|WARN\|DEBUG\|INFO\|CAUSED BY\).*'
